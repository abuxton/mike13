(function(){
  ...
  var Maps = function(elt){
    ...
    var _sources = {
      ...
      SotU:'Derived from Garrett Robinson’s <a target="_blank" href="http://web.mit.edu/sp.268/www/risk.pdf">The Strategy of Risk</a>'
    }

    var _maps = {
      SotU:{title:"Risk", p:{stiffness:400}, source:_sources.risk}
    }
